...
public class BigInt {
	...
	static String twoNumAdd(String A,String B){
	    ...
	    String decimal = decimalPartAdd(deciA, deciB);
	    String integer = integerPartAdd(intA, intB);
	    return integer + "." + decimal;
	   }
	  
	   static int sum = 0;
	   /* from right to left */
	   public static String integerPartAdd(String A, String B) {
	        int m = A.length() - 1;
	        int n = B.length() - 1;
	        String res = "";
	        int i = m, j = n;
	        ...
	        if (sum / 10 == 1) res = "1" + res;
	        
	        return res;
	    }
	  
	  /* from left to right */
	  public static String decimalPartAdd(String A, String B) {
	        int m = A.length() - 1;
	        int n = B.length() - 1;
	        String res = "";
	        int i = Math.max(m,n);
	  ...
	  public static String subNeg(String A, String B){
	        ...
	        if (!isNeg(A) && isNeg(B)) return integerPartAdd(A, B.substring(1));
	        if (isNeg(A) && !isNeg(B)) return "-"+integerPartAdd(A.substring(1), B);
	        else return sub(A, B);
	  }      
	  ...
	  public static String multiply(String num1, String num2) {
	        ...
	        // 移除前导零  
	        int i = 0;
	        while(sb.charAt(i) == '0' && i < sb.length() - 1) i++;
